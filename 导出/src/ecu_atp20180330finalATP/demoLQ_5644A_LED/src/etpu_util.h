...
#define FS_ETPU_SET_PARA24(ptr, offsetByte, data)  \
    (*((uint32_t *)(ptr) + (((offsetByte) - 1) >> 2)) = (data))
#define FS_ETPU_SET_PARA8(ptr, offsetByte, data)  \
    (*((uint8_t *)(ptr) + (offsetByte)) = (data))
#define FS_ETPU_SET_PARA32(ptr, offsetByte, data)  \
    (*((uint32_t *)(ptr) + ((offsetByte) >> 2)) = (data))

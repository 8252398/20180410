...
/****************************************************************************/
	...
	struct PBRIDGE_tag {
		...
		union {                               /* Master Privilege Registers 8-15 @baseaddress + 0x04*/
			...
			struct {
                 vuint32_t:1;      
				vuint32_t  MTR8:1;      /* Nexus: Master 8 Trusted for Reads */
				vuint32_t  MTW8:1;      /* Nexus: Master 8 Trusted for Writes */
				vuint32_t  MPL8:1;      /* Nexus: Master 8 Priviledge Level */
				 vuint32_t:28;      
            } B;
        } MPCR1;
		...
		union {                             /* Peripheral Access Conrol Registers 8-15 @baseaddress + 0x24*/
			...
			struct {
				vuint32_t:25;    
				vuint32_t  SP14:1;        /* SWT: Supervisor Protect */
				vuint32_t  WP14:1;        /* SWT: Write Protect */
				vuint32_t  TP14:1;        /* SWT: Trusted Protect */
				 vuint32_t:1;      
				vuint32_t  SP15:1;        /* STM: Supervisor Protect */
				vuint32_t  WP15:1;        /* STM: Write Protect */
				vuint32_t  TP15:1;        /* STM: Trusted Protect */ 
            } B;
        } PACR1;
		...
		union {                             /* Peripheral Access Conrol Registers 16-23 @baseaddress + 0x28*/
			...
			struct {
				vuint32_t:1;    
				vuint32_t  SP16:1;        /* ECSM: Supervisor Protect */
				vuint32_t  WP16:1;        /* ECSM: Write Protect */
				vuint32_t  TP16:1;        /* ECSM: Trusted Protect */
				 vuint32_t:1;      
				vuint32_t  SP17:1;        /* DMA: Supervisor Protect */
				vuint32_t  WP17:1;        /* DMA: Write Protect */
				vuint32_t  TP17:1;        /* DMA: Trusted Protect */ 
				 vuint32_t:1;      
				vuint32_t  SP18:1;        /* INTC: Supervisor Protect */
				vuint32_t  WP18:1;        /* INTC: Write Protect */
				vuint32_t  TP18:1;        /* INTC: Trusted Protect */ 
				 vuint32_t:20; 
            } B;
        } PACR2;
		...
		union {   							/* Off-Platform Access Control Registers 8-15 @baseaddress + 0x44*/
			...
			struct {
				 vuint32_t:17;      
				vuint32_t  SP12:1;      /* eSCIA: Supervisor Protect */
				vuint32_t  WP12:1;      /* eSCIA: Write Protect */
				vuint32_t  TP12:1;      /* eSCIA: Trusted Protect */
				 vuint32_t:1;    
				vuint32_t  SP13:1;      /* eSCIB: Supervisor Protect */
				vuint32_t  WP13:1;      /* eSCIB: Write Protect */
				vuint32_t  TP13:1;      /* eSCIB: Trusted Protect */
				 vuint32_t:1;   
				vuint32_t  SP14:1;      /* eSCIC: Supervisor Protect */
				vuint32_t  WP14:1;      /* eSCIC: Write Protect */
				vuint32_t  TP14:1;      /* eSCIC: Trusted Protect */
				 vuint32_t:4;
			} B;
        } OPACR1;	 
		...
		union {   							/* Off-Platform Access Control Registers 16-23 @baseaddress + 0x48*/
			...
			struct {
				 vuint32_t:1;      
				vuint32_t  SP16:1;      /* FlexCANA: Supervisor Protect */
				vuint32_t  WP16:1;      /* FlexCANA: Write Protect */
				vuint32_t  TP16:1;      /* FlexCANA: Trusted Protect */
				 vuint32_t:1;    
				vuint32_t  SP17:1;      /* FlexCANB: Supervisor Protect */
				vuint32_t  WP17:1;      /* FlexCANB: Write Protect */
				vuint32_t  TP17:1;      /* FlexCANB: Trusted Protect */
				 vuint32_t:1;   
				vuint32_t  SP18:1;      /* FlexCANC: Supervisor Protect */
				vuint32_t  WP18:1;      /* FlexCANC: Write Protect */
				vuint32_t  TP18:1;      /* FlexCANC: Trusted Protect */
				 vuint32_t:20;
			} B;
		} OPACR2;
		...
		union {   							/* Off-Platform Access Control Registers 24-31 @baseaddress + 0x4C*/
			...
			struct {
				 vuint32_t:1;      
				vuint32_t  SP24:1;      /* FlexRay: Supervisor Protect */
				vuint32_t  WP24:1;      /* FlexRay: Write Protect */
				vuint32_t  TP24:1;      /* FlexRay: Trusted Protect */
				 vuint32_t:9;    
				vuint32_t  SP27:1;      /* SIM: Supervisor Protect */
				vuint32_t  WP27:1;      /* SIM: Write Protect */
				vuint32_t  TP27:1;      /* SIM: Trusted Protect */
				 vuint32_t:13;   
				vuint32_t  SP31:1;      /* BAM: Supervisor Protect */
				vuint32_t  WP31:1;      /* BAM: Write Protect */
				vuint32_t  TP31:1;      /* BAM: Trusted Protect */
			} B;
		} OPACR3;
		...
		union {   							/* Off-Platform Access Control Registers 56-63 @baseaddress + 0x5C*/
			...
			struct {
				 vuint32_t:9;  
				vuint32_t  SP58:1;      /* CRC: Supervisor Protect */
				vuint32_t  WP58:1;      /* CRC: Write Protect */
				vuint32_t  TP58:1;      /* CRC: Trusted Protect */
				 vuint32_t:20; 
			} B;
		} OPACR7;
		...
		union {   							/* Off-Platform Access Control Registers 64-71 @baseaddress + 0x60*/
			...
			struct {
				 vuint32_t:1;  
				vuint32_t  SP64:1;      /* FMPLL: Supervisor Protect */
				vuint32_t  WP64:1;      /* FMPLL: Write Protect */
				vuint32_t  TP64:1;      /* FMPLL: Trusted Protect */
				 vuint32_t:1;  
				vuint32_t  SP65:1;      /* EBI: Supervisor Protect */
				vuint32_t  WP65:1;      /* EBI: Write Protect */
				vuint32_t  TP65:1;      /* EBI: Trusted Protect */
				 vuint32_t:1;  
				vuint32_t  SP66:1;      /* FlashA: Supervisor Protect */
				vuint32_t  WP66:1;      /* FlashA: Write Protect */
				vuint32_t  TP66:1;      /* FlashA: Trusted Protect */
				 vuint32_t:1;  
				vuint32_t  SP67:1;      /* FlashB: Supervisor Protect */
				vuint32_t  WP67:1;      /* FlashB: Write Protect */
				vuint32_t  TP67:1;      /* FlashB: Trusted Protect */
				 vuint32_t:1;  
				vuint32_t  SP68:1;      /* SIU: Supervisor Protect */
				vuint32_t  WP68:1;      /* SIU: Write Protect */
				vuint32_t  TP68:1;      /* SIU: Trusted Protect */
				 vuint32_t:9;  
				vuint32_t  SP71:1;      /* DTS: Supervisor Protect */
				vuint32_t  WP71:1;      /* DTS: Write Protect */
				vuint32_t  TP71:1;      /* DTS: Trusted Protect */
			} B;
		} OPACR8;
		...
		union {   							/* Off-Platform Access Control Registers 72-79 @baseaddress + 0x64*/
			...
			struct {
				 vuint32_t:1;  
				vuint32_t  SP72:1;      /* eMIOS: Supervisor Protect */
				vuint32_t  WP72:1;      /* eMIOS: Write Protect */
				vuint32_t  TP72:1;      /* eMIOS: Trusted Protect */
				 vuint32_t:25;  
				vuint32_t  SP79:1;      /* PMC: Supervisor Protect */
				vuint32_t  WP79:1;      /* PMC: Write Protect */
				vuint32_t  TP79:1;      /* PMC: Trusted Protect */
			} B;
		} OPACR9;
		...
		union {   							/* Off-Platform Access Control Registers 80-87 @baseaddress + 0x68*/
			...
			struct {
				 vuint32_t:1;  
				vuint32_t  SP80:1;      /* eTPU2: Supervisor Protect */
				vuint32_t  WP80:1;      /* eTPU2: Write Protect */
				vuint32_t  TP80:1;      /* eTPU2: Trusted Protect */
				 vuint32_t:1;  
				vuint32_t  SP81:1;      /* REACM: Supervisor Protect */
				vuint32_t  WP81:1;      /* REACM: Write Protect */
				vuint32_t  TP81:1;      /* REACM: Trusted Protect */
				 vuint32_t:1;  
				vuint32_t  SP82:1;      /* eTPU PRAM: Supervisor Protect */
				vuint32_t  WP82:1;      /* eTPU PRAM: Write Protect */
				vuint32_t  TP82:1;      /* eTPU PRAM: Trusted Protect */
				 vuint32_t:1;  
				vuint32_t  SP83:1;      /* eTPU PRAM mirror: Supervisor Protect */
				vuint32_t  WP83:1;      /* eTPU PRAM mirror: Write Protect */
				vuint32_t  TP83:1;      /* eTPU PRAM mirror: Trusted Protect */
				 vuint32_t:1;  
				vuint32_t  SP84:1;      /* eTPU CRAM: Supervisor Protect */
				vuint32_t  WP84:1;      /* eTPU CRAM: Write Protect */
				vuint32_t  TP84:1;      /* eTPU CRAM: Trusted Protect */
				 vuint32_t:12;  
			} B;
		} OPACR10;
		...
		union {   							/* Off-Platform Access Control Registers 88-95 @baseaddress + 0x6C*/
			...
			struct {
				 vuint32_t:17;  
				vuint32_t  SP92:1;      /* PIT: Supervisor Protect */
				vuint32_t  WP92:1;      /* PIT: Write Protect */
				vuint32_t  TP92:1;      /* PIT: Trusted Protect */
				 vuint32_t:12; 
			} B;
		} OPACR11;
...
/****************************************************************************/
    ...
    struct FLASH_tag {
        ...
        uint32_t FLASH_reserved0028[1];  /* 0x0028 */
		...
		uint32_t FLASH_reserved0030[3];  /* 0x0030-0x003B */
...
/****************************************************************************/
    struct SIU_tag {
		...
		vuint32_t SIU_Reserved_0038[2];      /* 0x0038 - 0x003F */
        ...
        int32_t SIU_Reserved_0928[21];     /* 0x092C - 0x097F */
        ...
        union {
            ...
            struct {
                ...
                vuint32_t REACMSTP:1;   /* REACM stop request. When asserted, a stop request is sent to the REACM module. */
        ...
        union {
            ...
            struct {
                vuint32_t CPUACK:1;     /* CPU stop acknowledge. When asserted, indicates that a stop acknowledge was */
                  vuint32_t:3;  /* Reserved */
                vuint32_t NSETIACK:1;   /* eTPU Nexus module stop acknowledge. When asserted, indicates that a stop acknowledge was */
                ...
                vuint32_t REACMACK:1;   /* Reaction module stop acknowledge. When asserted, indicates that a stop acknowledge was*/
...
/****************************************************************************/
	...
	typedef union uSYMBADHR {
        vuint16_t R;
        struct {
            vuint16_t SMBA:16;  /* system memory base addess high */
        } B;
    } SYMBADHR_t;
	...
	typedef union uSYMBADLR {
        vuint16_t R;
        struct {
            vuint16_t SMBA:12;  /* system memory base addess high */
			 vuint16_t:4;  
        } B;
    } SYMBADLR_t;
	...
	typedef union uPEDRDR {
        vuint16_t R;
        struct {
            vuint16_t DATA:16;    /* PE DRAM access instruction */
        } B;
    } PEDRDR_t;
	...
	typedef union uCASERCR {
        vuint16_t R;
        struct {
            vuint16_t STATUSERRCNT:16; /* channel status error counter */
        } B;
    } CASERCR_t;
...
/* wakeup status */
	...
	typedef union uMTCTR {
        vuint16_t R;
        struct {
            vuint16_t MTCT:16; /* macrotick counter */
        } B;
    } MTCTR_t;
	...
	typedef union uSFTOR {
        vuint16_t R;
        struct {
             vuint16_t SFTOFFSET:15; /* synch frame table offset */
			vuint16_t :1; 
        } B;
    } SFTOR_t;
	...
	typedef union uTI1MTOR {
        ...
        struct {
            vuint16_t:2;
            vuint16_t TI1MTOFFSET:14;      /* timer 1 macrotick offset */
        } B;
    } TI1MTOR_t;
	...
	typedef union uTI2CR0 {
        vuint16_t R;
        struct {
            vuint16_t TI2MTCNT:16;      /* timer 2 macrotick high word */
        } B;
    } TI2CR0_t;
	...
	typedef union uTI2CR1 {
        vuint16_t R;
        struct {
            vuint16_t TI2MTCNT:16;      /* timer 2 macrotick low word */
        } B;
    } TI2CR1_t;
	...
	typedef union uRFSYMBADHR {
        vuint16_t R;
        struct {
            vuint16_t SMBA:16;    /* systen memory base address */
        } B;
    } RFSYMBADHR_t;
	...
	typedef union uRFSYMBADLR {
        vuint16_t R;
        struct {
            vuint16_t SMBA:12;    /* systen memory base address */
			  vuint16_t:4;
        } B;
    } RFSYMBADLR_t;
	...
	typedef union uRFFLPCR {
        vuint16_t R;
        struct {
            vuint16_t PCB:8;      /* pop count FIFO B */
            vuint16_t PCA:8;      /* pop count FIFO A */
        } B;
    } RFFLPCR_t;
    ...
    typedef union uRFMIDAFVR {
        vuint16_t R;
        struct {
            vuint16_t MIDAFVAL:16;      /* message ID acceptance filter */
        } B;
    } RFMIDAFVR_t;
	...
	typedef union uEERICR {
        vuint16_t R;
        struct {
            vuint16_t BSY:1;     /* regsiter update busy */
            vuint16_t:5;    
    ...
    typedef struct FR_tag {
        ...
        volatile PEDRAR_t PEDRAR;        /*PE access register *//*10 */
        volatile PEDRDR_t PEDRDR;   /*PE data register *//*12 */
        ...
        volatile CIFR_t CIFR; /*combined interrupt flag register *//*3C */
        volatile SYMATOR_t SYMATOR; /* System Memory Access Time-Out Register *//*3E */
        ...
        volatile TI1MTOR_t T1MTOR;       /*timer 1 macrotick offset register *//*5E */
        ...
        volatile MTSACFR_t MTSACFR;      /*mts a config register *//*80 */
        volatile MTSBCFR_t MTSBCFR;      /*mts b config register *//*82 */
        volatile RSBIR_t RSBIR; /*receive shadow buffer index register *//*84 */
        volatile RFWMSR_t RFWMSR;   /*Receive FIFO Watermark and Selection Register *//*86 */
        ...
        volatile RFMIDAFMR_t RFMIDAFMR;   /*receive fifo message ID acceptance filter mask register *//*92 */
		...
		volatile RFFLPCR_t RFFLPCR; /*Receive FIFO Fill Level and POP Count Register *//*EE*/
